...
const MealLogPage = ({ onDataChanged }) => {
  ...
  useEffect(() => {
    if (onDataChanged && meals.length) {
        ...
        // Send data to parent/dashboard or update local state
      ...
      {successMessage && (
        ...
        <div className="d-none d-md-block">
            ...
            <tbody>
                ...
                <tr key={meal.id}>
                    <td>
                    <span className="me-1">{getMealIcon(meal.meal_type)}</span>
                    {meal.meal_type}
                    </td>
                    <td>{meal.name}</td>
                    <td>
        ...
        {meals.map((meal) => (
            ...
            <div className="card-body">
                ...
                <button className="btn btn-sm btn-outline-primary" onClick={() => handleEdit(meal)}>
                    Edit
                </button>
